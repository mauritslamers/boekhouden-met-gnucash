...
Je krijgt nu een tabblad Proefbalans. De cijfers in het kader gaan we straks gebruiken.
...
Klik bovenin de balk op het pictogram `Opties`, of zoek ernaar in het uitklapmenu mocht de knop niet zichtbaar zijn.
...
Deze stap is alleen maar nodig indien er later verkoopfacturen zijn ingevoerd in een periode waarvan de btw-aangifte al heeft plaatsgevonden. 
In dat geval is namelijk de btw wel bijgeschreven op de bijbehorende rekening `Schuld omzetbelasting`, maar de omzet-waarde van de factuur valt nog
...
We gaan er nu van uit dat het btw-bedrag onder de € 1000 euro blijft, en dat we dit kunnen verwerken in de eerstvolgende btw-aangifte.
...
Stel nu bij de opties van de `Winst- en verliesrekening` het begin in op het begin van het jaar, en het einde in op het einde van het kwartaal voorafgaand aan het kwartaal waarvan je de btw-aangifte doet. Kijk nu of de gezamenlijke omzet per btw-tarief van die periode overeenkomt met de optelsom van de omzet zoals je die hebt opgegeven.
...
- “1d. Privégebruik” hier vul je het bedrag en de btw van privéonttrekkingen in. Bijvoorbeeld als je privé rijdt in een auto van je onderneming vul je dat hier in.  Dit hoef je alleen bij de laatste aangifte van het jaar in te vullen.
